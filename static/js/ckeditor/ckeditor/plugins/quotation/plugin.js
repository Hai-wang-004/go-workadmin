...
CKEDITOR.plugins.add( 'quotation', {
	...
	init: function( editor ) {
		...
		CKEDITOR.dialog.add( 'quotation', this.path + 'dialogs/quotation.js' );

		// Register the simplebox widget.
		editor.widgets.add( 'quotation', {
			// Allow all HTML elements, classes, and styles that this widget requires.
			// Read more about the Advanced Content Filter here:
			// * http://docs.ckeditor.com/#!/guide/dev_advanced_content_filter
			// * http://docs.ckeditor.com/#!/guide/plugin_sdk_integration_with_acf
			allowedContent:
				'figure(!content-text-focus,align-left,align-right){width};' +
				'div(!content-text-caption); span(!content-text-caption-title)',

			// Minimum HTML which is required by this widget to work.
			requiredContent: 'figure(content-text-focus)',

			// Define two nested editable areas.
			editables: {
				title: {
					// Define CSS selector used for finding the element inside widget element.
					selector: '.content-text-caption-title',
			...
			template:
                ...
                '<figure class="content-text-focus">' +
			...
			upcast: function( element ) {
				...
				return element.name == 'div' && element.hasClass( 'content-text-focus' );
			},
